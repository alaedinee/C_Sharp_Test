...
<div id="tabsPrestation" style="width:100%; min-height: 300px">
              ...
              <%if (_isOpen.ToString() != "0" && _isPalannifToPast.ToString() != "0")
                { %>
                <div>
                    <img id="btn_addPrest" src="<%: Globale_Varriables.VAR.get_URL_HREF()  %>/Images/addd.png" width='32' height='32' style="cursor:pointer;margin-right:7px" />
                </div>
                <% } %>
                <div>     
                        <%
...
<div id="contrDgPr">
 ...
 <script type="text/javascript">
     ...
     $(function () {
             ...
             "fnDrawCallback": function (oSettings) {
                 $("#prestList tr[index]").each(function () {
                     ...
                     if (_tdcount.length == _nbrCol - 1) {
                         ...
                         $(this).append(Articles + modifier + Supprimer + BL);
                         <%}else{ %>
                         $(this).append(Articles + BL);
                         <% }} %>
                     }
                     ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
         ...
         $("#prestList").find("a[detailPrestEvent]").click(function () {
         ...
         $("#prestList").find("a[histoPrestEvent]").unbind('click').click(function () {
         ...
         $("#prestList").find("a[annulerPrestEvent]").unbind('click').click(function () {
         ...
         $("#prestList").find("a[activerEvent]").unbind('click').click(function () {
         ...
         $("#prestList").find("a[supprimerPrestEvent]").unbind('click').click(function () {
         ...
         $("#prestList").find("a[envoyerEvent]").unbind('click').click(function () {
         ...
         $("#prestList").find("a[historyPrestEvent]").unbind('click').click(function () {
         ...
         $("#prestList").find("a[articlesEvent]").unbind('click').click(function () {
         ...
         $("#prestList").find("a[BLEvent]").unbind('click').click(function () {
         ...
         $("#prestList").find("a[BLEvent]").each(function () {
                var _prestDetailID = $(this).attr("BLEvent");
                var Element = $(this);
