	...
	calendar.prototype.init = function (){
		...
		if(this.allowFullMonth){
			...
			this.currMonth.onclick = function(){
				document.getElementById(me.destinations[0]).value = "01/"+ ((me.monthCurrent+1 == 13) ? 1:me.monthCurrent+1)+"/"+me.yearCurrent;
		...
		if(this.allowFullMonth){
			...
			this.pYear.onclick = function(){
				document.getElementById(me.destinations[0]).value = "01/01/"+me.yearCurrent;
	...
	calendar.prototype.fillField = function () {
	    ...
	    var month;
	    month = (this.monthCurrent + 1 == 13) ? 1 : this.monthCurrent + 1;
	    var day;
	    day = this.dayCurrent;
	    ...
	    this.element.value = day + "/" + month + "/" + this.yearCurrent;
