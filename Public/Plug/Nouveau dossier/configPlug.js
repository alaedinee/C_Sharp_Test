...
var Config = {
	...
	PlanStep : 30,
    panelWidth : 300,
	zoom:  {"1" : "<div class='row'><div class='col-md-2'>{misIcons}</div><div {cData} class='col-md-7' style='font-size:9px'>{settings.label}</div><div class='col-md-3 pull-right text-right'>{icons}</div></div>",
	    "2": "<div class='row'><div class='col-md-2'>{misIcons}</div><div {cData} class='col-md-7' style='font-size:9px'>{settings.label}<br />{settings.info.zip} {settings.info.city}</div><div class='col-md-3'>{icons}</div></div>",
