	...
	var ___methods = {
        ...
        draw : function(idx) { 
			if(defaults.prop_Orders_visible[idx]){
				...
				$("#orderPanel").append('<div PropPeriode="' + ((parseInt(settings.id)>0)? settings.Period : settings.id) + '" class="well PropOrder" style="padding:7px 5px;margin:10px 0px;"' + 
